        ...
        <form action="" method="post">
            <div class="form-group has-danger">
                ...
                <input type="text" name="mail" value="<?php if(isset($_POST['mail'])){echo $_POST['mail'];}?>"
                       ...
                       class="form-control <?php if(isset($erreur) AND array_key_exists('mail',$erreur)){echo "is-invalid";}?>"" id="inputInvalid">
                <div class="invalid-feedback"><?php if(isset($erreur) AND array_key_exists('mail',$erreur)){echo $erreur['mail'];}?></div>
            </div>
