...
<!--/////Affichage dynamique du N°facture (id > voir index.php) en le récupérant dans l'URL...-->
    <h1 class="p-5" style="text-align:center">Facture: <?=$_GET['id']?></h1>
...
/////SELECT *** WHERE num_invoice est défini en récupérant "id" (> voir index.php) ds l'URL...
...
/////SELECT *** INNER JOIN WHERE num_invoice est défini en récupérant "id" ()> voir index.php) ds l'URL...
